...
export function Hierarchie() {
    ...
    const currentEntities = currentSceneId ? engineStore.scenes[currentSceneId]?.entities : null;
    const initialData: NodeData[] = currentEntities ? [Object.values(currentEntities)[0] as NodeData] : [];
    ...
    const handleAddComponent = (componentType: string) => {
        ...
        const componentSchema = useSchemaStore.getState().schemas[componentType].properties;
        engineStore.addComponentToEntity(currentSceneId!, initialData[0].id, { id: Component.id, name: Component.name, type: Component.type, props: componentSchema });
    }
